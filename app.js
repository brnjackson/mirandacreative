  ...
  element.addEventListener("click", () => {
    switch (element.id) {
      case "1 expand":
        ...
        document.querySelector(".card1").style.zIndex = "150";
        break;
      case "2 expand":
